...
sidebar_label: Use the Portal Plugin
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

The Portal Plugin provides useful features to aid in communication between your Web and Native applications. It is included in the Ionic Portals library by default and takes advantage of the Capacitor Plugin system.
...
To access the initial context from the Portal Plugin in your web application, import Portals and use the [Portals.getInitialContext()](../reference/web/portals-plugin#getinitialcontext) function.
...
The Publish and Subscribe mechanism (pub/sub) in the Portal Plugin allows you to send data between your web and native applications through a Portal. 
...
The Portal Plugin is used in the [E-Commerce App](./examples/ecommerce-app) demo.
