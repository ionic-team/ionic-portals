...
:::note
This is one of two live update sources a Portal can use. If you want to sync a Portal's web assets from a different update service than Appflow, see [Using a Live Update Provider](./how-to/using-a-live-update-provider.md).
:::
