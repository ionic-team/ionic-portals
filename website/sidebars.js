    ...
    'choosing-a-communication',
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Tutorials',
          collapsed: true,
          items: ['for-ios/tutorials/auth-token-example', 'for-ios/tutorials/monorepo-example'],
        },
        {
          type: 'category',
          label: 'Examples',
          collapsed: true,
          items: ['for-ios/examples/ecommerce-app', 'for-ios/examples/ecommerce-app-live-updates'],
        },
        {
          type: 'category',
          label: 'Reference',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Tutorials',
          collapsed: true,
          items: ['for-android/tutorials/auth-token-example', 'for-android/tutorials/monorepo-example'],
        },
        {
          type: 'category',
          label: 'Examples',
          collapsed: true,
          items: ['for-android/examples/ecommerce-app', 'for-android/examples/ecommerce-app-live-updates'],
        },
        {
          type: 'category',
          label: 'Reference',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Tutorials',
          collapsed: true,
          items: ['for-react-native/tutorials/auth-token-example', 'for-react-native/tutorials/monorepo-example'],
        },
        {
          type: 'category',
          label: 'Examples',
